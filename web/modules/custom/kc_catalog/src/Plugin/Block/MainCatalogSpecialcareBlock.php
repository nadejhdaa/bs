...
/**
 * Provides a catalog basecare block block.
 */
#[Block(
  id: 'kc_catalog_main_catalog_specialcare_block',
  admin_label: new TranslatableMarkup('Catalog Specialcare Block'),
  category: new TranslatableMarkup('Custom'),
)]
final class MainCatalogSpecialcareBlock extends BlockBase implements ContainerFactoryPluginInterface {

  const VID = 'specialcare';
