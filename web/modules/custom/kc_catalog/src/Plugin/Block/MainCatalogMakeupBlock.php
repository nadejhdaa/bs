 ...
 */
#[Block(
  id: 'kc_catalog_main_catalog_makeup_block',
  admin_label: new TranslatableMarkup('Main Catalog Makeup'),
  category: new TranslatableMarkup('Custom'),
)]
final class MainCatalogMakeupBlock extends BlockBase implements ContainerFactoryPluginInterface {
