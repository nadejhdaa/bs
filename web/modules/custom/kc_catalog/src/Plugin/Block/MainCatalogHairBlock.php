 ...
 */
#[Block(
  id: 'kc_catalog_main_catalog_hair_block',
  admin_label: new TranslatableMarkup('Main Catalog Hair'),
  category: new TranslatableMarkup('Custom'),
)]
final class MainCatalogHairBlock extends BlockBase implements ContainerFactoryPluginInterface {
