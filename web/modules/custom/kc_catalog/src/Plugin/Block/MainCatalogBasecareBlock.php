 ...
 */
#[Block(
  id: 'kc_catalog_main_catalog_basecare_block',
  admin_label: new TranslatableMarkup('Catalog Basecare Block'),
  category: new TranslatableMarkup('Custom'),
)]
final class MainCatalogBasecareBlock extends BlockBase implements ContainerFactoryPluginInterface {
